...
public class MenuController : MonoBehaviour {
	...
	// public Button PressToSelectBird;

	// Use this for initialization
	void Awake () {
		MakeInstance();

		// PressToSelectBird = GameObject.FindGameObjectWithTag ("SelectingBird").GetComponent<Button>();
		// PressToSelectBird.onClick.AddListener (() => ChangeBird());
	}
